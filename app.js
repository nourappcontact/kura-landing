...
const I18N = {
  es: {
    ...
    card3Body: '500 niveles de pura lógica con dificultad real. Sin prisas, sin azar: solo tu cabeza.',
  ...
  en: {
    ...
    card3Body: '500 levels of pure logic with real difficulty. No rush, no luck: just your brain.',
